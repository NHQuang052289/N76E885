...
#define P23_Quasi_Mode				P2M1&=~SET_BIT3;P2M2&=~SET_BIT3
#define P24_Quasi_Mode				P2M1&=~SET_BIT4;P2M2&=~SET_BIT4
#define P25_Quasi_Mode				P2M1&=~SET_BIT5;P2M2&=~SET_BIT5
#define P26_Quasi_Mode				P2M1&=~SET_BIT6;P2M2&=~SET_BIT6

#define P30_Quasi_Mode				P3M1&=~SET_BIT0;P3M2&=~SET_BIT0
#define P31_Quasi_Mode				P3M1&=~SET_BIT1;P3M2&=~SET_BIT1
#define P32_Quasi_Mode				P3M1&=~SET_BIT2;P3M2&=~SET_BIT2
#define P33_Quasi_Mode				P3M1&=~SET_BIT3;P3M2&=~SET_BIT3
#define P34_Quasi_Mode				P3M1&=~SET_BIT4;P3M2&=~SET_BIT4
#define P35_Quasi_Mode				P3M1&=~SET_BIT5;P3M2&=~SET_BIT5
#define P36_Quasi_Mode				P3M1&=~SET_BIT6;P3M2&=~SET_BIT6
#define P37_Quasi_Mode				P3M1&=~SET_BIT7;P3M2&=~SET_BIT7

#define GPIO0_Quasi_Mode			P0M1 = 0x00; P0M2 = 0x00
#define GPIO1_Quasi_Mode			P1M1 = 0x00; P1M2 = 0x00
#define GPIO2_Quasi_Mode			P2M1 = 0x00; P2M2 = 0x00
#define GPIO3_Quasi_Mode			P3M1 = 0x00; P3M2 = 0x00
...
#define P21_PushPull_Mode			P2M1&=~SET_BIT1;P2M2|=SET_BIT1
#define P22_PushPull_Mode			P2M1&=~SET_BIT2;P2M2|=SET_BIT2
#define P23_PushPull_Mode			P2M1&=~SET_BIT3;P2M2|=SET_BIT3
#define P24_PushPull_Mode			P2M1&=~SET_BIT4;P2M2|=SET_BIT4
#define P25_PushPull_Mode			P2M1&=~SET_BIT5;P2M2|=SET_BIT5
#define P26_PushPull_Mode			P2M1&=~SET_BIT6;P2M2|=SET_BIT6

#define P30_PushPull_Mode			P3M1&=~SET_BIT0;P3M2|=SET_BIT0
#define P31_PushPull_Mode			P3M1&=~SET_BIT1;P3M2|=SET_BIT1
#define P32_PushPull_Mode			P3M1&=~SET_BIT2;P3M2|=SET_BIT2
#define P33_PushPull_Mode			P3M1&=~SET_BIT3;P3M2|=SET_BIT3
#define P34_PushPull_Mode			P3M1&=~SET_BIT4;P3M2|=SET_BIT4
#define P35_PushPull_Mode			P3M1&=~SET_BIT5;P3M2|=SET_BIT5
#define P36_PushPull_Mode			P3M1&=~SET_BIT6;P3M2|=SET_BIT6
#define P37_PushPull_Mode			P3M1&=~SET_BIT7;P3M2|=SET_BIT7

#define GPIO0_PushPull_Mode		P0M1 = 0x00;P0M2 = 0xFF
#define GPIO2_PushPull_Mode		P2M1 = 0x00;P2M2 = 0xFF
#define GPIO3_PushPull_Mode		P3M1 = 0x00;P3M2 = 0xFF
...
#define P21_Input_Mode				P2M1|=SET_BIT1;P2M2&=~SET_BIT1
#define P22_Input_Mode				P2M1|=SET_BIT2;P2M2&=~SET_BIT2
#define P23_Input_Mode				P2M1|=SET_BIT3;P2M2&=~SET_BIT3
#define P24_Input_Mode				P2M1|=SET_BIT4;P2M2&=~SET_BIT4
#define P25_Input_Mode				P2M1|=SET_BIT5;P2M2&=~SET_BIT5
...
#define P33_Input_Mode				P3M1|=SET_BIT3;P3M2&=~SET_BIT3
#define P34_Input_Mode				P3M1|=SET_BIT4;P3M2&=~SET_BIT4
#define P35_Input_Mode				P3M1|=SET_BIT5;P3M2&=~SET_BIT5
#define P36_Input_Mode				P3M1|=SET_BIT6;P3M2&=~SET_BIT6
#define P37_Input_Mode				P3M1|=SET_BIT7;P3M2&=~SET_BIT7

#define GPIO0_Input_Mode			P0M1 = 0xFF; P0M2 = 0x00
#define GPIO1_Input_Mode			P1M1 = 0xFF; P1M2 = 0x00
#define GPIO2_Input_Mode			P2M1 = 0xFF; P2M2 = 0x00
#define GPIO3_Input_Mode			P3M1 = 0xFF; P3M2 = 0x00
...
*****************************************************************************************/
    ...
    #define TIMER_DIV4_VALUE_1ms				65536-5000  	//5000*4/20000000 = 1 mS,   Timer Clock = Fsys/4
		...
		#define TIMER_DIV16_VALUE_10ms			65536-13824			//13824*16/22118400 = 10 ms			// Timer divider = 16
		#define TIMER_DIV64_VALUE_30ms			65536-10368			//10368*64/22118400 = 30 ms			// Timer divider = 64
		#define TIMER_DIV64_VALUE_20ms			65536-6912			//6912*64/22118400 = 20 ms			// Timer divider = 64
